...
[State](https://api.flutter.dev/flutter/widgets/State-class.html)&lt;[FactBrowser](../../main/FactBrowser-class.md)> createState
()
...
later inserted into the tree again, the framework will call <a href="../../main/FactBrowser/createState.md">createState</a>
